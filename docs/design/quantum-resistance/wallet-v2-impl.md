...
| **W7** | Only `kemSchemeId` was validated; `ringSchemeId` was not (despite the comment). | **FIXED.** Added `PQ_RING_SCHEME_ID = 0xC0DE0003` (now `0x52415054` "RAPT") and validate `adr.ringSchemeId` in parse. |
